...
public class GOMOKU {
    ...
    public static int loadC;//1发生load,0不做load
    public static int counter;//棋子计数器
    ...
    public static void doLoad() throws IOException {
    ...
    public static void printChoose3() {
        clear();
        while (!StdDraw.isMousePressed()) {
            StdDraw.picture(0.5, 0.5, "preface5.png");
        }
    ...
    public static void win2(int a) {
        ...
        while (!StdDraw.isMousePressed()) {
            if (a == 1) {
                StdDraw.picture(0.5, 0.5, "bluewin.png");
            }
            if (a == 2) {
                StdDraw.picture(0.5, 0.5, "redwin.png");
            }
        }
    ...
    public static void save() throws FileNotFoundException {
        System.out.print(0);
        try (
                PrintWriter pr = new PrintWriter("chess.txt")) {
            pr.print(HoC + " " + midtime + " " + mm + " " + c + " ");
            for (int i = 0; i < state.length; i++) {
